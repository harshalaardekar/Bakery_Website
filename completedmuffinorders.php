...
<div class="row"> 
  <br><br>
  <a href="pendingmuffinorers.php"><button class="btn1"> Pending</button></a>&nbsp;&nbsp;&nbsp;&nbsp;
  <a href="completedmuffinorders.php"><button class="btn1" > Completed</button></a>
  <br><br>
              ...
              <div class="box">
                ...
                <tbody>
                      <?php
                      $query="select * from muffinorders where status=1";
