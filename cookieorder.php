...
/*Form*/
input[type=text],input[type=date],input[type=number],input[type=integer],select,textarea,label
{
  border-radius: 10px;
  height:27px;
  width: 160px;
...
<div class="row">
  ...
  <br>
   <div style="width:90%; background-color:white; border-style:inset; border-width:1px; border-radius: 10px; margin-left: 5%;">
    <center>
     <form action="cookieorderprocess.php" method="POST">
   <br>
      <fieldset><br>
    ...
    <fieldset>  <br>
     ...
     <fieldset><br>
      <legend>Order Details</legend>
        ...
        <?php
          $type=$_POST["ordernow"];
          echo "<input type='text1' name='type' value='$type' />";
         ?>
        <br><br>
        <label>Quantity :</label>
        <?php
          $quantity=$_POST['quantity'];
          echo "<input type='text1' name='quantity' value='$quantity' />" 
        ?>
        <br><br>
        <lable>Date:</lable>
        ...
        <label>Price:</label>
        <?php
            $sql="select price from cookie where name='$type'";
