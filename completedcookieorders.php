...
<div class="row"> 
  <br><br>
  <a href="pendingcookieorders.php"><button class="btn1"> Pending</button></a>&nbsp;&nbsp;&nbsp;&nbsp;
  <a href="completedcookieorders.php"><button class="btn1" > Completed</button></a>
  <br><br>
              ...
              <div class="box">
                ...
                <tbody>
                      <?php
                      $query="select * from cookieorders where status=1";
