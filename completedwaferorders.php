...
<div class="row"> 
  <br><br>
  <a href="pendingwaferorders.php"><button class="btn1"> Pending</button></a>&nbsp;&nbsp;&nbsp;&nbsp;
  <a href="completedwaferorders.php"><button class="btn1" > Completed</button></a>
  <br><br>
              ...
              <div class="box">
                ...
                <tbody>
                      <?php
                      $query="select * from waferorders where status=1";
