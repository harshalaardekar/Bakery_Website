...
<div class="row"> 
  <br><br>
  <a href="pendingbreadorders.php"><button class="btn1"> Pending</button></a>&nbsp;&nbsp;&nbsp;&nbsp;
  <a href="completedbreadorders.php"><button class="btn1" > Completed</button></a>
  <br><br>
              ...
              <div class="box">
                ...
                <tbody>
                      <?php
                      $query="select * from breadorders where status=1";
